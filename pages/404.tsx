  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center h-[100vh] text-center font-bold px-3">
        ...
        <Link href="/">
          <button className="text-lg text-white px-6 py-2 rounded-xl md:px-8 md:text-2xl bg-[#208ce5] duration-300 hover:-translate-y-1 hover:scale-110 hover:bg-[white] hover:text-[#208ce5]">Home</button>
        </Link>
      </div>
    </>
  );
