...
export default function Posts({ data }: any) {
  ...
  function handleInput() {
    ...
    if (inputValue === "") {
      ...
      setCountResult(filteredData.length);
    }
  }
  ...
  return (
    <>
      <PageHead />
      <NavBar onPage="Posts"/>
      <div className="flex flex-col items-center gap-y-[2vh] min-h-[90vh]">
        { /* Search Bar */ }
        <div className="flex items-center w-[75vw] h-[5.55vh] rounded-[1.85vh] bg-white sm:w-[41.67vw] sm:h-[5.55vh]">
        ...
        <div className="flex flex-col gap-y-[5vh] sm:flex-row">
          {
