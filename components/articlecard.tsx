  ...
  return (
    <Link href={`posts/${data.id}`}>
      <button className="w-[75vw] h-fit p-[2.3vh] bg-[white] rounded-[2.78vh] sm:w-[41.67vh] duration-300 hover:-translate-y-1 hover:scale-105">
        ...
        <div className="text-white flex flex-row flex-wrap justify-start gap-x-[4vw] mb-[0.92vh] sm:gap-x-[0.78vw]">
          {
        ...
        <p className="text-[#1A1C2B] text-justify text-[1.85vh] leading-tight line-clamp-3"><StructuredText data={data.content} /></p>
      </button>
    </Link>
  );
}